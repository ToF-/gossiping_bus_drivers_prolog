...
test('at minute 0, albert has albert and barnabe\'s gossips') :-
   gossips(albert,0,Gossips),  write(Gossips), nl, Gossips == [albert,barnabe].
...
test('at minute 0 clara has only her gossips') :-
    gossips(clara,0,Gossips),
    write(Gossips),
    nl,
    Gossips == [clara].
test('at minute 1, clara and barnabe share their gossips from minute 0') :-
    gossips(clara, 1, Gossips), write(Gossips), nl, Gossips == [albert,barnabe,clara].
